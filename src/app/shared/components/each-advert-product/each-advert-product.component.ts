...
@Component({
  selector: 'app-each-advert-product',
  templateUrl: './each-advert-product.component.html',
  styleUrls: ['./each-advert-product.component.scss']
})
export class EachAdvertProductComponent implements OnInit {
  @Input() product;
  @Input() currency;
