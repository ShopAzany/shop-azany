...
export class UserRatingsService {
  ...
  getRatings(loginID: number, limit = 5, page = 1) {
  ...
  // Get product Ratings by pid
  productDetailRatings(pid: number, limit = 5, page = 1) {
    return this.http.get<any>(
      this.serverUrl + 'products/productRatings/' + pid +
      '/' + limit + '/' + page
    );
  }
