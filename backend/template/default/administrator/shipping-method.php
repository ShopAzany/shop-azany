...
<div class="page-content">
  ...
  <?php if(isset($_GET["add"]) && $_GET["add"] == 'success') { ?>
    <div class="alert alert-primary alert-dismissible fade show" role="alert">
      Shipping method successfully added
  ...
  <div class="row">
    <div class="col-xl-5 grid-margin">
      <form class="forms-sample" method="post" action="<?=Config::ADMIN_BASE_URL()?>other_manager/add_shipping_method" enctype="multipart/form-data">
        <div class="card">
          <div class="card-body">
            <h6 class="card-title"> Add Shipping Method </h6>
    ...
    <div class="col-xl-7 grid-margin">
      ...
      <div class="card">
        <div class="card-body pl-0 pr-0">
          <h6 class="card-title pl-4">All Shipping Methods</h6>
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                <?php foreach ($getShipMethod as $method): ?>
                <tr>
                  <td>
                    <?php if($method->url) { ?>
                  ...
                  <td><?=$method->name?></td>
                  <td><?=$curr->symbol?><?=number_format($method->price)?></td>
                  <td>
                  ...
                  <td>
                    <a href="<?=Config::ADMIN_BASE_URL()?>other_manager/edit_shipping_method/<?=$method->id?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <form method="post" class="mt-4" action="<?=Config::ADMIN_BASE_URL()?>other_manager/delete_shipping_method">
