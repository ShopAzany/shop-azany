    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
            <?php foreach ($allPages as $page): $count += 1; ?>
            <tr>
              <td><?=$count?></td>
              <td><?=$page->title?></td>
              <td><?=CustomDateTime::dateFrmatAlt($page->created_at)?></td>
              <td><?=CustomDateTime::dateFrmatAlt($page->updated_at)?></td>
              <td><a href="<?=Config::ADMIN_BASE_URL()?>content_manager/edit_page/<?=$page->id?>" class="btn btn-primary btn-sm">Edit</a></td>
            </tr>
            <?php endforeach ?>
