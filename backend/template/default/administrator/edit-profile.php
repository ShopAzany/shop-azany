...
<div class="page-content">
  ...
  <form class="forms-sample" method="post" action="<?=Config::ADMIN_BASE_URL()?>account_settings/update_profile" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="full_name" autocomplete="off" name="full_name" value="<?=$this->admin()->full_name?>">
            </div>

            <div class="form-group">
              <label for="site_name">Username</label>
              <input type="text" class="form-control" id="site_name" value="<?=$this->admin()->username?>" readonly>
            </div>

            <div class="form-group">
              <label for="role">Role</label>
              <input type="text" class="form-control" id="role" name="role" value="<?=$this->admin()->role?>">
            </div>

            <div class="form-group">
              <label for="email">Email</label>
              <input type="email" class="form-control" id="email" name="email" value="<?=$this->admin()->email?>">
            </div>

            <div class="form-group">
              <label for="phone">Phone Number</label>
              <input type="text" class="form-control" id="phone" name="phone" value="<?=$this->admin()->phone?>">
            </div>

            <div class="form-group">
              <label for="address">Address</label>
              <input type="text" class="form-control" id="address" name="address" value="<?=$this->admin()->address?>">
            </div>

            <div class="form-group">
              <label for="city">City</label>
              <input type="text" class="form-control" id="city" name="city" value="<?=$this->admin()->city?>" >
            </div>

            <div class="form-group">
              <label for="state">State</label>
              <input type="text" class="form-control" id="state" name="state" value="<?=$this->admin()->state?>">
            </div>

            <div class="form-group">
              <label for="country">Country</label>
              <input type="text" class="form-control" id="country" name="country" value="<?=$this->admin()->country?>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            <input type="file" id="myDropify" class="border" name="photo" data-default-file="<?=$this->admin()->photo?>" />
            <?php } else { ?>
        ...
        <div class="card mt-3">
          <div class="card-body">
            <div class="form-group">
              ...
              <textarea class="form-control" rows="7" name="bio"><?=$this->admin()->bio?></textarea>
            </div>
          </div>
        </div>
      </div>
