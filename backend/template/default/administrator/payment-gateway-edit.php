...
<div class="page-content">
  ...
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?=Config::ADMIN_BASE_URL()?>other_manager/payment_gateway">Payment Gateway</a></li>
  ...
  <div class="row">
    <div class="col-xl-5 grid-margin">
      <form class="forms-sample" method="post" action="<?=Config::ADMIN_BASE_URL()?>other_manager/update_pay_method" enctype="multipart/form-data">
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control custom-select" name="type" required>
                <option value="<?=$method->type?>"><?=ucwords($method->type)?></option>
                <option>Bank</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control custom-select" name="gateway" required>
                <option value="<?=$method->gateway?>"><?=ucwords($method->gateway)?></option>
            ...
            <div class="form-group">
              <label>Mer ID</label>
              <input type="text" class="form-control" name="mer_id" value="<?=$method->mer_id?>">
            </div>

            <div class="form-group">
              <label>Mer Code</label>
              <input type="text" class="form-control" name="mer_code" value="<?=$method->mer_code?>">
            </div>


            <div class="form-group">
              <label>Bearer</label>
              <input type="text" class="form-control" name="bearer" value="<?=$method->bearer?>">
            </div>

            <div class="form-group">
              <label>Description</label>
              <textarea class="form-control" rows="7" name="descr"><?=$method->descr?></textarea>
            </div>

            <div class="form-group">
              <input type="hidden" name="defGateIcon" value="<?=$method->url?>">
              <p>Gate Icon</p>
