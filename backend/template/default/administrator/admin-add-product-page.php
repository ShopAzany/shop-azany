    ...
    <div class="page-content">
      ...
      <nav class="page-breadcrumb">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?=Config::ADMIN_BASE_URL().'product_manager'?>">All products</a></li>

          <li class="breadcrumb-item active" aria-current="page">Admin product page</li>
        ...
        <div class="col-md-12 grid-margin">
          ...
          <div class="row justify-content-center mt-5">
            ...
            <div class="col-xl-10">
              ...
              <form method="post" action="<?=Config::ADMIN_BASE_URL()?>product_manager/add_admin_product">
                ...
                <div class="form-wrapper card card-body">
                  ...
                  <input type="hidden" name="uid" value="<?=$this->admin()->id?>">
