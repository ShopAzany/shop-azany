...
<section class="email-wrap" style="background: #E5E5E5; width: 100%; padding: 20px 0px; font-family: calibri">
	<div class="content-wrap">
		...
		<div class="logo-wrapp" style="text-align: center; padding-top: 30px;">
			...
			<p>Hi David! Here's your weekly updates</p>
		</div>

		<div class="product-wrap" style="margin-top: 50px;">
			<div class="each-product" style="margin-top: 70px">
				<div class="img-wrap" style="height: 250px; width: 100%">
					<img src="<?=$this_folder?>/assets/images/product/pro3.png" style="height: 100%; width: 100%; object-fit: cover;">
				</div>
				<h3>Here Are The Best Sneakers of 2021</h3>
			...
			<div class="each-product" style="margin-top: 70px">
				<div class="img-wrap" style="height: 250px; width: 100%">
					<img src="<?=$this_folder?>/assets/images/product/pro1.png" style="height: 100%; width: 100%; object-fit: cover;">
				</div>
				<h3>Here Are The Best Sneakers of 2021</h3>
				<p style="text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			...
			<div class="each-product" style="margin-top: 70px">
				<div class="img-wrap" style="height: 250px; width: 100%">
					<img src="<?=$this_folder?>/assets/images/product/pro2.png" style="height: 100%; width: 100%; object-fit: cover;">
				</div>
				<h3>Here Are The Best Sneakers of 2021</h3>
				<p style="text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
