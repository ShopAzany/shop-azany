...
<div class="page-content">
  ...
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Featured Category</li>
    </ol>
  </nav>

  <?php if(isset($_GET["add"]) && $_GET["add"] == 'success') { ?>
    <div class="alert alert-primary alert-dismissible fade show" role="alert">
      Feature category successfully set
  ...
  <div class="row">
    <div class="col-xl-5 grid-margin">
      <form class="forms-sample" method="post" action="<?=Config::ADMIN_BASE_URL()?>product_manager/add_feature" enctype="multipart/form-data">
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="file" id="myDropify" class="border" name="full_width_banner"/>
            </div>
            <div class="form-group">
              <label>Full Width Banner Link</label>
              <input type="text" class="form-control" name="full_width_banner_link">
            </div>


            <div class="form-group">
              <label>Left Banner</label>
              <input type="file" id="myDropifyLeftBanner" class="border" name="left_banner"/>
            </div>
            <div class="form-group">
              <label>Left Banner Link</label>
              <input type="text" class="form-control" name="left_banner_link">
            </div>


            <div class="form-group">
              <label>Right Banner</label>
              <input type="file" id="myDropifyRightBanner" class="border" name="right_banner"/>
            </div>
            <div class="form-group">
              <label>Left Banner Link</label>
              <input type="text" class="form-control" name="right_banner_link">
            </div>


            <div class="text-center mt-5 mb-5">
              <button type="submit" class="btn btn-primary p-3">Set Feature</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div class="col-xl-7 grid-margin">
      ...
      <div class="card">
        <div class="card-body">
          <h6 class="card-title">All Banners (<?=count($features)?>)</h6>
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              ...
              <div class="d-flex justify-content-between mt-3">
                ...
                <div>
                  <a href="<?=Config::ADMIN_BASE_URL()?>product_manager/edit_feature_category/<?=$feat->id?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
