<?php
	class account_settings extends controller {
		...
		public function business_info_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
		...
		public function dashboard_info_alt($sellerID, $duration='days'){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function register_business_info($token){
			...
			if (isset($isAuth['sellerID']) && is_numeric($isAuth['sellerID'])) {
				...
				$sellerTable = seller::where('seller_id', $sellerID)->update(['biz_info_status' => 1]);
		...
		public function register_business_info_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function update_business_info_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function bank_info_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function update_bank_info_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function delete_bank_info_alt($sellerID, $id){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function updateProfile_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
		...
		public function change_password_alt($sellerID){
			//$isAuth = HeadersControl::seller($token);
			HeadersControl::guest('holder');
			if ($sellerID && is_numeric($sellerID)) {
				//$sellerID = $isAuth['sellerID'];
